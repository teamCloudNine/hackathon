...
* The original package name 'com.hackathon.springboard.beneficiary-collaboration-service' is invalid and this project uses 'com.hackathon.springboard.beneficiarycollaborationservice' instead.
